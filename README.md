...
Los datos obtenidos se almacenan temporalmente en formato Parquet y en una base local DuckDB donde se curan y se aplican las primeras reglas de negocio. Posteriormente, se transforman y se cargan en un esquema analítico dentro de AWS Redshift.
